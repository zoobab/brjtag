...
static void loadftdll(void)
{
    ...
    if(ftDll == NULL)
    {
        printf("Couldn't load ftd2xx DLL liberary\n");
        exit (1);
    }
...
void ftset_instr(DWORD instr)
{
  FT_STATUS Status;
  FTDI_AddBlkToTXDataBuffer(instr, TAP_IR|TAP_WO, instruction_length,1);
